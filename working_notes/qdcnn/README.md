...
This directory contains notes, literature reviews, and experimental design for the Quantum Dilated Convolutional Neural Networks (QDCNN) project.
...
- `literature/` - Paper summaries and bibliography related to QDCNN
- `insights/` - Casual insights and observations (more structured than scribble, less formal than concepts)
- `concepts/` - Concept-focused notes and summaries for QDCNN
- `ideas/` - Idea bank and experiment queue for QDCNN
- `experiment_design/` - Experimental design artifacts, baselines, benchmarks, and analysis plans
- `results/` - Results analysis, figures, tables, and summaries
